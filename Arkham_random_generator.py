...
def getCampaign(CampaignNumber):
    ...
    elif CampaignNumber==7:
        return "The Innsmouth Conspiracy"
    elif CampaignNumber==8:
        return "The Edge of the Earth"
...
def getInvestigator(InvestigatorNumber):
    if InvestigatorNumber == 1:
        ...
        return "Zoey"
    elif InvestigatorNumber == 43:
        return "Trish"
    elif InvestigatorNumber == 44:
        return "Daniella"
    elif InvestigatorNumber == 45:
        return "Monterey Jack"
    elif InvestigatorNumber == 46:
        return "Bob"
    elif InvestigatorNumber == 47:
        return "Lily Chen"
    elif InvestigatorNumber == 48:
        return "Parallel Skids"
    elif InvestigatorNumber == 49:
        return "Parallel Roland"
    elif InvestigatorNumber == 50:
        return "Parallel Agnes"
    elif InvestigatorNumber == 51:
        return "Parallel Daisy"
...
while True:
    ...
    campaign = input()
    if campaign == "y":
        CampaignNumber = random.randint(1,8)
...
while True:
    ...
    if int(Investigators)== 1:
        ...
        InvestigatorNumber2 = random.randint(1,51)
        Investigator2 = getInvestigator(InvestigatorNumber2)
        InvestigatorNumber3 = random.randint(1,51)
        ...
        InvestigatorNumber3 = random.randint(1,51)
        Investigator3 = getInvestigator(InvestigatorNumber3)
        InvestigatorNumber4 = random.randint(1,51)
